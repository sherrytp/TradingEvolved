"""
A simple Pipeline algorithm that longs the top 3 stocks by RSI and shorts the bottom 3 each day.
"""
...
#### TODO: Not sure about handle_data in here, added mannually
def handle_data(context, data):
    order(context.asset, 10)
    record(NEWT=data.current(context.asset, 'price'))
...
# zipline run --bundle quantopian-quandl -f momentum_pipeline_zipline_model6.py
# --start 2013-10-7 --end 2013-11-30 --output momentum_pipeline_v1.pickle --no-benchmark
